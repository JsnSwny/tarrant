...
class Chatbot {
	...
	acceptAnswer() {
		if (this.isCorrectAnswer(this.answerOffered)) {
			...
			this.utter("say-correct", [this.currentPrize, this.winnings, this.answerOffered]);
			if (this.io) {
			...
			this.utter("say-incorrect", [this.question["correct_answer"], this.currentPrize, this.winnings, this.answerOffered]);
			if (this.io) {
				this.io.emit("question_result", {
					isCorrect: false,
					answerOffered: this.answerOffered,
